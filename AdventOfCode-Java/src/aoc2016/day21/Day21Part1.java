...
public class Day21Part1 {
    ...
    private static String rotatePosition(String password, char c) {
        ...
        if(index >= 4) {
            password = rotateRight(password, 2 + index);
        }
        else {
            password = rotateRight(password, 1 + index);
        }
    ...
    private static String move(String password, int posX, int posY) {
        ...
        char c = password.charAt(posX);
        password = password.substring(0, posX) + password.substring(posX + 1);
        password = password.substring(0, posY) + c + password.substring(posY);
